      ...
      <div class="flex h-14 items-center justify-between">
        ...
        <div class="flex items-center gap-3">
          ...
          <a href="https://github.com/SynkennL/JustifyyUIKit" target="_blank" rel="noopener noreferrer"
            class="hidden md:flex p-2 text-slate-500 hover:text-slate-900 hover:bg-slate-100 rounded-lg transition-all"
            title="GitHub">
      ...
      <div v-if="isMobileMenuOpen" class="md:hidden border-t border-slate-200 bg-white">
        <nav class="flex flex-col px-6 py-4 space-y-1">
          <a v-for="link in navLinks" :key="link.name" :href="link.href" @click="closeMobileMenu"
            class="px-3 py-2 text-slate-600 hover:text-slate-900 hover:bg-slate-50 rounded-lg transition-colors">
            {{ link.name }}
          </a>
          ...
          <a href="https://github.com/SynkennL/JustifyyUIKit" target="_blank" rel="noopener noreferrer"
            ...
            class="flex items-center gap-2 px-3 py-2 text-slate-600 hover:text-slate-900 hover:bg-slate-50 rounded-lg transition-colors">
